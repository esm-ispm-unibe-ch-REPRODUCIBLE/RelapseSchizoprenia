...
I excluded all the studies that did not have the N_UseAntiparkinsonDrugs
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
```
The network consists of 43 two-arm studies and 1 three-arm study.
...
Again, as the network is thin the power of test is very low.
...
ORFrequentist<-as.data.frame(ORFrequentist[-19,])
