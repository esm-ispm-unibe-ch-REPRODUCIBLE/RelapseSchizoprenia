...
The network consists of 31 two-arm studies and 1 three-arm study.
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
NMAdataContinuous=make.jagsNMA.data(studyid=Final_ID_all,t=Drug_name,y=Weight_mean, sd=Weight_sd, n=Weight_participants,data=DATA,type="cont",reference = "Placebo oral or depot")
