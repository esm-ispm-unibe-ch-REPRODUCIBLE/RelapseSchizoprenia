...
I excluded all the studies that did not have the informations about QTc_participants, QTc_mean or QTc_sd and also studies 4334 & 4380 were excluded because of disconnected network
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
NMAdataContinuous=make.jagsNMA.data(studyid=Final_ID_all,t=Drug_name,y=QTc_mean, sd=QTc_sd, n=QTc_participants,data=DATA,type="cont",reference = "Placebo oral or depot")
