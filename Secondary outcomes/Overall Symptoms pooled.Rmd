...
I excluded all the studies that did not have information about OverallSymptoms_participants (also 1-arm studies were excluded), OverallSymptoms_mean or OverallSymptoms_sd
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
```
The network consists of 36 two-arm studies and 2 three-arm studies.
...
There is no evidence of inconsistency in the data. There are 
...
```
comparison which gives a % of inconsistent loops equal to
```{r, echo=F, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
NMAdataContinuous=make.jagsNMA.data(studyid=Final_ID_all,t=Drug_name,y=OverallSymptoms_mean, sd=OverallSymptoms_sd, n=OverallSymptoms_participants,data=DATA,type="cont",reference = "Placebo")
