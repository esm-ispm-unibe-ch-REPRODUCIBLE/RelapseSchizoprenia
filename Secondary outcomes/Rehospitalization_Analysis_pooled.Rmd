...
I excluded all the studies that did not have the N_rehospitalized (also single-arms studies)
```{r, echo=FALSE, message=FALSE, warning=FALSE}
DATA<-DATA1[!is.na(DATA1$N_rehospitalized),]
excludeID <-c(3189,4330,4334,4380,4440,4496,4519)
...
```
The network consists of 27 two-arm studies.
...
There is a little evidence of inconsistency in the data. There are in total
...
We acknowledge that the power of this test is low, because the network is thin.
