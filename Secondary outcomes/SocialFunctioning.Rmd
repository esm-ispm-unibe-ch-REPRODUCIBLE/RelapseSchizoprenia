...
The network consists of 20 two-arm studies.
...
#forest plots
forest(net1, ref="Placebo oral or depot", sortvar = -Pscore,xlab="SMD")

forest(net1, ref="Placebo oral or depot", xlab="SMD")
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
NMAdataContinuous=make.jagsNMA.data(studyid=Final_ID_all,t=Drug_name,y=SocialFunctioning_mean, sd=SocialFunctioning_sd, n=SocialFunctioning_participants,data=DATA,type="cont",reference = "Placebo oral or depot")
